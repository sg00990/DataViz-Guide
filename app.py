...
def scatter_plot():
    ...
    st.scatter_chart(df, x="Station Name", y="Distance from Tokyo Station", x_label="Station Name", y_label="Distance from Tokyo Station (km)", size="Company", color=('#c18489', '#e3a8b3', '#87bbe2', '#c7daed', '#6298c0'))
